...
class Sidebar extends \tiFy\App\Component
{
    ...
    public function __construct()
    {
        ...
        $this->appAddFilter('body_class', null, 10, 2);
    }
    ...
    {
        // Bypass
        if (!self::tFyAppConfig('wp_inline_scripts', true)) {
            return;
        }
        ...
        <style type="text/css">
            .tiFySidebar {
            <?php if( $width = self::tFyAppConfig( 'width' ) ) :?> width: <?php echo $width ?>;
            <?php endif;?><?php if( $zindex = self::tFyAppConfig( 'z-index' ) ) :?> z-index: <?php echo $zindex;?>;
            <?php endif;?>
            }
     ...
     */
    public static function register($id = null, $args = [])
    {
        if (!$id) {
            $id = uniqid();
        }
     ...
     * @return string
     */
    public static function displayToggleButton($args = [], $echo = true)
    {
        $defaults = [
            'pos'   => self::tFyAppConfig('pos'),
