...
class FontAwesome extends \tiFy\App\Factory
{
	...
	public function __construct()
	{
		...
		\tiFy\Components\TinyMCE\TinyMCE::registerExternalPlugin( 'fontawesome', self::tFyAppUrl() . '/plugin.js' );
	}
	...
	final public function init()
	{
		...
		wp_register_style( 'tinymce-fontawesome', self::tFyAppUrl() . '/plugin.css', array(), '20141219' );
