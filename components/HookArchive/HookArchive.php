...
final class HookArchive extends \tiFy\App\Component
{
    ...
    private static $AllowedObject = ['post_type', 'taxonomy'];
    ...
    public function __construct()
    {
        ...
        $this->appAddFilter('wp_title_parts');
        $this->appAddFilter('post_type_archive_title', null, 10, 2);
        $this->appAddFilter('single_term_title');
    }
            ...
            switch ($obj) :
                ...
                case 'taxonomy' :
                    foreach (self::$Hooks['taxonomy'] as $archive => $Class) :
                        ...
                        $terms = wp_get_post_terms($post_id, $archive, ['fields' => 'ids']);
