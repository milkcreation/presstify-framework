...
namespace tiFy\Components\TabMetaboxes\PostType\Fileshare;

use tiFy\TabMetabox\ContentPostTypeController;

class Fileshare extends ContentPostTypeController
{
    /**
     * {@inheritdoc}
     */
            ...
            function () {
                if ($this->get('max', -1) !== 1) :
                    \wp_enqueue_style(
                        ...
                        \assets()->url('/metabox/post-type/fileshare/css/styles.css'),
                        [],
                        151216
                    );
                    \wp_enqueue_media();
                    \wp_enqueue_script(
                        'MetaboxPostTypeFileshare',
                        \assets()->url('/metabox/post-type/fileshare/js/scripts.js'),
