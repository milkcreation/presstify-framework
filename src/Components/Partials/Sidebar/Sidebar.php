...
use tiFy\Components\Partials\Sidebar\Walker;
...
class Sidebar extends AbstractPartialController
{
    ...
    public function init()
    {
        \wp_register_style(
            'tiFyPartial-Sidebar',
            $this->appAsset('/Sidebar/css/styles.css', get_class()),
            [],
            180511
        );
        \wp_register_script(
            'tiFyPartial-Sidebar',
            $this->appAsset('/Sidebar/css/scripts.js', get_class()),
            ['jquery'],
            180511,
            true
        );
    ...
    protected function parse($attrs = [])
    {
        ...
        $this->set(
                'attrs.class',
                'tiFySidebar--' . $this->getId()
            )
            ->set(
                'attrs.class',
                'tiFySidebar tiFySidebar--' . $this->getId()
            )
            ->set(
                'attrs.style',
        ...
        */
        return  $this->appTemplateRender(
                ...
                $this->compact(
                    ['pos'],
                    [
                        'items' => Walker::display($this->get('nodes', [])),
