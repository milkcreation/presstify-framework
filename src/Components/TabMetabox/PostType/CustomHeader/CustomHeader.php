...
namespace tiFy\Components\TabMetabox\PostType\CustomHeader;

use tiFy\Metadata\Post as PostMetadata;
use tiFy\Field\Field;
use tiFy\TabMetabox\Controller\AbstractTabContentPostTypeController;

class CustomHeader extends AbstractTabContentPostTypeController
{
    /**
