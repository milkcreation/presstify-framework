...
namespace tiFy\Partial\Partials\Downloader;

use Exception;
use Symfony\Component\HttpFoundation\Response as SfResponse;
use tiFy\Contracts\{Partial\Downloader as DownloaderContract,
    Partial\PartialFactory as PartialFactoryContract,
    Routing\Route};
...
class Downloader extends PartialFactory implements DownloaderContract
{
    /**
