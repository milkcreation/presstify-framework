 ...
 *
 * class AccordionMenu extends \tiFy\Control\AccordionMenu\AccordionMenu
 * {
 *
 * }
 */

class AccordionMenu extends \tiFy\Control\Factory
{
    /**
     * DECLENCHEURS
     */
    ...
    protected function display($attrs = [])
    {
        ...
        $Nodes = self::tFyAppLoadOverride('tiFy\Control\AccordionMenu\Nodes');
        switch ($type) :
            case 'terms' :
        ...
        $Walker = self::tFyAppLoadOverride('tiFy\Control\AccordionMenu\Walker');
