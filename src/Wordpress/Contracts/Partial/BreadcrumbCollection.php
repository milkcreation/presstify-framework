...
use tiFy\Contracts\Partial\BreadcrumbCollection as BaseBreadcrumbCollectionContract;
use WP_Post;

interface BreadcrumbCollection extends BaseBreadcrumbCollectionContract
{
    /**
