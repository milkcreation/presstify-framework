 ...
 *
 * class Modal extends \tiFy\Control\Modal\Modal
 * {
 *
 * }
 */

class Modal extends \tiFy\Control\Factory
{
    /**
     * DECLENCHEURS
     */
     ...
     * @uses \tiFy\Control\Control::enqueue_scripts('modal') - Appel depuis les classes et/ou méthodes
     *
     * @return void
     */
     ...
     * @uses \tiFy\Control\Control::Modal($attrs, true);|\tiFy\Control\Control::display('Modal', $attrs); - Appel depuis les classes et/ou méthodes
     *
     * @param array $attrs {
     ...
     * @uses \tiFy\Control\Control::call('Modal', 'trigger', $attrs, $echo) - Appel depuis les classes et/ou méthodes
     *
     * @param array $attrs {
     *      Liste des attributs de configuration
     *
     ...
     *          @see \tiFy\Control\Modal\Modal::display()
     *      }
     * }
