...
namespace tiFy\Components\Partial\CookieNotice;
...
class CookieNotice extends AbstractPartialItem
{
    ...
    public function wp_ajax()
    {
        ...
        $cookie_name = $this->appRequest('POST')->get('cookie_name', '');
        $cookie_hash = $this->appRequest('POST')->get('cookie_hash', '');
        $cookie_expire = $this->appRequest('POST')->get('cookie_expire', '');
    ...
    protected function getCookie($name, $salt = true)
    {
        ...
        return $this->appRequest('COOKIE')->get($name . $salt, '');
    }
