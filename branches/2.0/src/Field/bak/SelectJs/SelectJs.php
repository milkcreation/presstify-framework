...
class SelectJs extends FieldController
{
     ...
     *      @var bool $removable Activation/Désactivation de la suppression d'un élément dans la liste des éléments sélectionné.
        ...
        $this->set(
            ...
            rawurlencode(
                json_encode(
                    array_merge(
                        [
                            'adminbar' => (is_admin() && (!defined('DOING_AJAX') || (DOING_AJAX !== true)))
                                ? false : true,
                        ],
                        $this->get('picker')
                    ),
