...
interface RadioChoice extends ParamsBag
{
     ...
     * @return static
     */
    public function build(): RadioChoice;
     ...
     * @return static
     */
    public function setNameAttr(string $name): RadioChoice;
     ...
     * @return static
     */
    public function setChecked(): RadioChoice;

    /**
     * Définition de l'instance du gestionnaire d'affichage de la liste des éléments.
     *
     * @param RadioWalker $walker
     *
     * @return static
     */
    public function setWalker(RadioWalker $walker): RadioChoice;
}