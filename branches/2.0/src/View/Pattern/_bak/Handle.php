...
namespace tiFy\Layout\Share\ListTable\Handle;
...
class Handle
{
    ...
    {
        if ($this->layout->request()->query('action', -1) != -1) :
            return $this->layout->request()->query('action');
        endif;
        if ($this->layout->request()->get('action2', -1) != -1) :
            return $this->layout->request()->get('action2');
        endif;
    ...
    public function proceed()
    {
        ...
        elseif ($this->layout->request()->get('_wp_http_referer')) :
            \wp_redirect(
                \remove_query_arg(
