...
namespace {
    ...
    function tify_modal_toggle($args = [], $echo = true)
    {
        return tiFy\Lib\Modal\Modal::toggle($args, $echo);
    }

    /** == Création d'une modale == **/
    function tify_modal($args = [], $echo = true)
    {
