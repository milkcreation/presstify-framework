...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=1a75be280f0890c06408)
 * Config saved to config.json and https://gist.github.com/1a75be280f0890c06408
 */
...
jQuery(document).ready( function($){
	...
	$( 'a[data-toggle="tab"]', '.taboox-container' ).on( 'shown.bs.tab', function(e){		
    	if( $(this).data('current') && $(this).data('group') )
    		$.post( ajaxurl, { action: 'editbox_current_tab', current: $(this).data('current'), tabindex : $(this).data('group') } );
	});
