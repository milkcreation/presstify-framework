...
class Actions extends BaseActions implements ActionsContract
{
    ...
    public function doCreate(): JsonResponseInterface
    {
                ...
                [
                    ...
                    'views'   => [
                        'notice' => (string)$this->notice(
                            __('Le nom du dossier ne peut être vide.', 'tify'),
                            'warning'
                        ),
                    ],
                ]
        ...
        if ($this->factory->filesystem()->createDir($path)) {
            ...
            return JsonResponse(
                [
                    ...
                    'views'   => [
                        ...
                        'notice'     => (string)$this->notice(
                            __('Le dossier a été créé avec succès.', 'tify'),
                            'success'
                        ),
                    ],
                ]
        ...
        return JsonResponse(
            [
                ...
                'views'   => [
                    'notice' => (string)$this->notice(
                        __('ERREUR SYSTEME : Impossible de créer le dossier.', 'tify'),
                        'error'
                    ),
                ],
            ]
        ...
        if (!$this->factory->filesystem()->has($path)) {
            return JsonResponse(
                [
                    ...
                    'views'   => [
                        'notice' => $this->notice(
                            __('Impossible de trouver l\'élément à supprimer.', 'tify'),
                            'warning'
                        ),
                    ],
                ]
    ...
    public function doRename(): JsonResponseInterface
    {
        ...
        if (!$this->factory->filesystem()->has($path)) {
            return new JsonResponse(
                [
                    ...
                    'views'   => [
                        'notice' => $this->notice(
                            __('Impossible de trouver l\'élément à renommer.', 'tify'),
                            'warning'
                        ),
                    ],
                ]
        ...
        if ($this->factory->adapter()->rename($path, $newpath)) {
        ...
        return new JsonResponse([
            ...
            'views'   => [
                'notice' => (string)$this->notice(
                    __('ERREUR SYSTEME : Impossible de renommer l\'élément.', 'tify'),
                    'error'
                ),
            ],
        ]);
