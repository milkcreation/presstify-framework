...
class Factory extends \tiFy\App\Factory
{
    ...
    public function __construct($args = [])
    {
        ...
        add_action('tify_options_register_node', [$this, 'tify_options_register_node']);
    }
        ...
        switch ($this->Obj) :
            case 'post_type' :
                ...
                if (!empty($hooks)) :
                    ...
                    $hooks = get_option("tify_hook_" . $this->Obj . "_" . $this->Archive, [[]]);
                endif;
                break;
            case 'taxonomy' :
                $defaults['term'] = 0;
    ...
    final public function GetArchiveSlug($hook_id)
    {
        ...
        $permalink_structure[] = [
            'permalink' => get_permalink($hook_id),
            'name'      => $hook->post_name,
