...
class SplFileInfo extends \SplFileInfo
{
     ...
     * @since 5.1.2
     */
    public function __construct ($filename, $infos)
    {
    ...
    {
        if (isset($this->Infos['dirname'])) :
            return $this->Infos['dirname'];
        endif;
    }
