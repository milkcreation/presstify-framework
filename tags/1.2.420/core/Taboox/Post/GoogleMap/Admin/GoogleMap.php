...
class GoogleMap extends \tiFy\Core\Taboox\Admin
{
    ...
    public function admin_enqueue_scripts()
    {
        ...
        wp_enqueue_style('tiFyTabooxGoogleMap', self::tFyAppAssetsUrl('GoogleMap.css', get_class()), array('dashicons','spinkit-circle'), '170703');
        wp_enqueue_script('GoogleMapApi', "https://maps.googleapis.com/maps/api/js?key={$this->args['ApiKey']}&libraries=places", array(), false );
        wp_enqueue_script('tiFyTabooxGoogleMap', self::tFyAppAssetsUrl('GoogleMap.js', get_class()), array('jquery', 'jquery-ui-widget'), '170703', true);
    }
