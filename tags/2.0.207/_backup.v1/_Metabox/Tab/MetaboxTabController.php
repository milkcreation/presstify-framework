...
namespace _tiFy\Metabox\Tab;

use Closure;
use _tiFy\Contracts\Metabox\MetaboxManager;
use _tiFy\Contracts\Metabox\MetaboxFactory;
use _tiFy\Wordpress\Contracts\WpScreen;
use _tiFy\Kernel\Params\ParamsBag;
