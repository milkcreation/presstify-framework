...
class Slideshow extends \tiFy\Core\Taboox\Options\Admin
{
    ...
    {
    ?>
        <div id="tify_taboox_slideshow-<?php echo self::$Instance;?>" class="tify_taboox_slideshow tiFyTabooxSlideshow" data-max="<?php echo $this->args['max'];?>" data-action="<?php echo $this->Action;?>">        
