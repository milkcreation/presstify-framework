<?php
/**
 * @var tiFy\Field\TemplateController $this
 */
?>
...
<div <?php $this->attrs(); ?>>
    <a href="#tiFyField-MediaImageAdd--<?php echo $this->getIndex(); ?>" id="tiFyField-MediaImageAdd--<?php echo $this->getIndex(); ?>" class="tiFyField-MediaImageAdd" title="<?php _e('Modification de l\'image', 'tify'); ?>"
        style="background-image:url(<?php echo $this->get('value_img', '');?>); width:100%; padding-top: <?php echo 100*($this->get('height')/$this->get('width')) . "%;"; ?><?php echo $this->get('editable', true) ? 'cursor:pointer;' : 'cursor:default;'; ?>">
    ...
    <input type="hidden" class="tiFyField-MediaImageInput" name="<?php echo $this->get('name', ''); ?>" value="<?php echo $this->getValue(); ?>"/>
