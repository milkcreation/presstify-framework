 ...
 * @package presstiFy
 * @namespace tiFy\Control\DropdownGlyphs
 * @version 1.1
 * @subpackage Core
 * @since 1.2.502
 *
...
use tiFy\Lib\File;
use tiFy\ScriptLoader\ScriptLoader;
 ...
 *
 * class DropdownGlyphs extends \tiFy\Control\DropdownGlyphs\DropdownGlyphs
 * {
 *
 * }
 */

class DropdownGlyphs extends \tiFy\Control\Factory
{
    /**
     * DECLENCHEURS
     */
