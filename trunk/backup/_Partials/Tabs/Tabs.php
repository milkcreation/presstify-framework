 ...
 *
 * class Tabs extends \tiFy\Control\Tabs\Tabs
 * {
 *
 * }
 */

class Tabs extends \tiFy\Control\Factory
{
    /**
     * CONSTRUCTEUR
     *
    ...
    protected function display($attrs = [])
    {
        ...
        /**
         * @var \tiFy\Control\Tabs\Nodes $Nodes
         */
        $Nodes = self::tFyAppLoadOverride('tiFy\Control\Tabs\Nodes');
        ...
        /**
         * @var \tiFy\Control\Tabs\Walker $Walker
         */
        $Walker = self::tFyAppLoadOverride('tiFy\Control\Tabs\Walker');
